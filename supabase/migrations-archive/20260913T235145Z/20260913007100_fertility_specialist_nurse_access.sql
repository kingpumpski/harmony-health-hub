...
BEGIN
 ...
 PERFORM public.record_system_audit('fertility_cycle_created','fertility','fertility_cycle',v_cycle.id,'info',jsonb_build_object('patient_id',_patient_id,'cycle_type',v_cycle.cycle_type)); RETURN v_cycle;
END; $$;
...
BEGIN
 ...
 PERFORM public.record_system_audit('fertility_monitoring_recorded','fertility','fertility_monitoring',v_row.id,'info',jsonb_build_object('cycle_id',_cycle_id,'visit_date',_visit_date)); RETURN v_row;
END; $$;
...
BEGIN
 ...
 PERFORM public.record_system_audit('fertility_cycle_transitioned','fertility','fertility_cycle',v_cycle.id,'info',jsonb_build_object('status',v_cycle.status,'outcome',v_cycle.outcome)); RETURN v_cycle;
END; $$;
