-- Reconcile the continuity aggregator with the canonical global HIMS column names.
-- Emergency uses arrival_time; transfusion uses unit_identifier, started_at and completed_at.
