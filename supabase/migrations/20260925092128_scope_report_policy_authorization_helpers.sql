-- Scope client-visible report/RBAC policy evaluation to the authenticated session.
...
create policy config_access on public.facility_report_config for select to authenticated
