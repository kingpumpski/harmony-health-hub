...
-- Treatment-before-deposit remains administrator-controlled through facility settings.
...
BEGIN
  ...
  IF v_override THEN
    FOR v_order IN
      ...
      FOR UPDATE
    LOOP
      -- Record the emergency financial authorization without pretending payment was received.
