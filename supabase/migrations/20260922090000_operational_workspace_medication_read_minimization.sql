-- Remove an unrelated staff profile projection from the medication administration workspace.
-- The operational medication workspace returns medication records only.
