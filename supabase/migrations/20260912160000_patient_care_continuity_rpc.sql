-- Consolidated longitudinal patient-care read model.
-- Read-only RPC keeps the Patient Care Continuity screen from requiring
-- broad client-side queries across sensitive clinical domains.
...
BEGIN
  ...
  IF NOT (
    ...
    public.has_role(uid,'lab_technician') OR
