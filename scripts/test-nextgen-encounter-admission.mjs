...
assert(encounters.includes('admit_encounter_workflow') && encounters.includes('Admit'), 'Encounter admission action surface is missing');
assert(!app.includes('EncounterAdmissionActions'), 'Superseded floating encounter admission overlay remains mounted');
