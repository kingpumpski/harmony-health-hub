...
const required = [
  'docs/next-gen-hims/00-ARCHITECTURE-DECISION.md','docs/next-gen-hims/01-MODULE-CATALOG.md','docs/next-gen-hims/02-CONFIGURATION-AND-DATA-SOVEREIGNTY.md','docs/next-gen-hims/03-INTEROPERABILITY-AND-DEVICE-INTEGRATION.md','docs/next-gen-hims/04-AI-SAFETY-AND-GOVERNANCE.md','docs/next-gen-hims/05-ACCESSIBILITY-AND-PATIENT-ENGAGEMENT.md','docs/next-gen-hims/06-SECURITY-PRIVACY-COMPLIANCE.md','docs/next-gen-hims/07-STANDARDS-MATRIX.md','docs/next-gen-hims/08-IMPLEMENTATION-ROADMAP.md','docs/next-gen-hims/09-QUALITY-GATE.md','docs/next-gen-hims/10-TRACEABILITY-MATRIX.md','docs/next-gen-hims/11-RISK-REGISTER.md','docs/next-gen-hims/12-CLINICAL-SAFETY-SECURITY-CONVERGENCE.md','docs/next-gen-hims/13-IMPLEMENTATION-STATUS.md','docs/next-gen-hims/14-DOMAIN-RECONCILIATION.md','platform/reference/module-registry.json','src/lib/nextGenPlatform.ts','src/lib/nextGenContracts.ts','src/lib/nextGenModuleManifest.ts','src/lib/nextGenClinicalSafety.ts','src/pages/admin/NextGenPlatformControlCenter.tsx','supabase/migrations/20260915150000_nextgen_platform_foundation.sql','supabase/migrations/20260915160000_nextgen_integration_delivery.sql'];
...
console.log(`Next-gen contract verification passed: ${ids.length} modules; ${required.length} required artifacts; RLS, lifecycle, idempotency, safety and runtime-contract checks present.`);
