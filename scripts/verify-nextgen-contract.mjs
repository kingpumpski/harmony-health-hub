...
if (packageJson.scripts?.['test:nextgen-clinical-workflows'] !== 'node scripts/test-nextgen-clinical-workflows.mjs') throw new Error('Clinical workflow boundary test script is not wired into package scripts');
