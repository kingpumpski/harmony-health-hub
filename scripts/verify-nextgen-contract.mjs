...
console.log(`Next-gen contract verification passed: ${ids.length} modules; ${required.length} required artifacts; RLS, lifecycle, idempotency, safety, integration-runtime and AI-governance checks present.`);
