...
assert('smtp-hosted-boundary',provider.includes('smtpPort===25||smtpPort===587')&&provider.includes('smtpPort===465')&&provider.includes('secure!==true'),'hosted SMTP ports 25/587 must be rejected and 465 must require TLS');
