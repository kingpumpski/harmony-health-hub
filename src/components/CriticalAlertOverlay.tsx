...
export default function CriticalAlertOverlay() {
  ...
  return (
    <div className="fixed top-20 right-0 z-[9998] w-[min(22rem,calc(100vw-1rem))] space-y-2">
      {alerts.map(a => (
        <div key={a.id} className="rounded-l-xl border-2 border-r-0 border-critical bg-critical text-critical-foreground p-4 shadow-elevated animate-scale-in pulse-critical">
