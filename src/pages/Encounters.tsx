  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      {selected && (
        ...
        <section className="rounded-2xl border border-border p-4">
          <div className="flex items-center justify-between gap-3 mb-3"><div><h3 className="font-semibold flex items-center gap-2"><FileText className="w-4 h-4 text-primary" /> Clerking sheet</h3><p className="text-xs text-muted-foreground">History, examination context and treatment plan remain part of the auditable encounter document.</p></div></div>
